...
CREATE TABLE "Note" (
    ...
    "cityTownGooglePlaceId" TEXT NOT NULL,
    "stateProvinceGooglePlaceId" TEXT NOT NULL,
    "countryGooglePlaceId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "CityTown_googlePlaceId_key" ON "CityTown"("googlePlaceId");

-- CreateIndex
CREATE UNIQUE INDEX "CityTown_name_stateProvinceId_countryId_key" ON "CityTown"("name", "stateProvinceId", "countryId");

-- CreateIndex
CREATE UNIQUE INDEX "StateProvince_googlePlaceId_key" ON "StateProvince"("googlePlaceId");

-- CreateIndex
CREATE UNIQUE INDEX "StateProvince_name_countryId_key" ON "StateProvince"("name", "countryId");

-- CreateIndex
CREATE UNIQUE INDEX "Country_googlePlaceId_key" ON "Country"("googlePlaceId");
